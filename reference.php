...
<body>
	<header>
        ...
        <img id="icon-bag" src="img/Feature/shopping-bag-regular-24.png" alt="">
        <div class="cart">
	...
	<main>
        <div class="product-container" id="product-container">
            <div class="product">
                <img class = "product-img" src="Images/Tatum.jpg" alt="">
            ...
            <div class="product">
                <img class = "product-img" src="Images/Zion.jpg" alt="">
            ...
            <div class="product">
                <img class = "product-img" src="Images/jordan 13.jpeg" alt="">
            ...
            <div class="product">
                <img class = "product-img" src="Images/whynot.jpg" alt="${item.name}">
            ...
            <div class="product">
                <img class = "product-img" src="Images/stadium.jpg" alt="${item.name}">
            ...
            <div class="product">
                <img class = "product-img" src="Images/seriesmid.jpg" alt="${item.name}">
            ...
            <div class="product">
                <img class = "product-img" src="Images/retro 6.jpg" alt="${item.name}">
            ...
            <div class="product">
                <img class = "product-img" src="Images/airjordan1low.jpg" alt="${item.name}">
